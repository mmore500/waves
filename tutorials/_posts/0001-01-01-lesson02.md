...
[These instructions](https://github.com/Hintzelab/MABE/wiki/Installation-and-getting-started-with-MABE#windows-guide-to-installing-and-configuring-the-dependencies) from the MABE Wiki might provide a more lightweight alternative.
...
## Evolutionary Algorithm Terminology

![book]({{ site.baseurl }}/assets/gifcities-book.gif){:width="100%"}
...
![explorer]({{ site.baseurl }}/assets/gifcities-explorer.gif){:width="100%"}
...
If we `ls --recursive` or `tree`, we can see the organizational structure of the
```
.
├── AUTHORS.rst
├── CONTRIBUTING.rst
...
![watering]({{ site.baseurl }}/assets/gifcities-watering.gif){:width="100%"}
...
![diary]({{ site.baseurl }}/assets/gifcities-diary.gif){:width="100%"}
...
![exercise]({{ site.baseurl }}/assets/gifcities-exercise.gif){:width="100%"}
...
![trophy]({{ site.baseurl }}/assets/gifcities-trophy.gif){:width="100%"}
...
![jog]({{ site.baseurl }}/assets/gifcities-plug.gif){:width="100%"}
...
![jog]({{ site.baseurl }}/assets/gifcities-jog.gif){:width="100%"}
...
C++ has notoriously unhelpful, long error messages.
...
We're also happy to chat error messages on the Slack or Zoom!
...
git clone https://github.com/mmore500/evo-algo-example
cd evo-algo-example
make && ./evoalgo
```
...
:bangbang: If you run the `repl.it` more than once, you'll want to start over [back at the initial graphing script](https://repl.it/@mmore500/evo-algo) to avoid weird `repl.it` bugs.

## Experimentation!

![experiment]({{ site.baseurl }}/assets/gifcities-experiment.gif){:width="100%"}
