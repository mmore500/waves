...
Given that our goal is approximating a given function f(x), we will want to define it in terms of it. [????]
...
It sounds like a job for the sinusoidal family of functions.
...
Let's hope over to Godbolt, where we have set up an online Python script to graph your data.

## Graphing

![graph]({{ site.baseurl }}/assets/gifcities-graph.gif){:width="100%"}

[Click here to open the graphing script]()
