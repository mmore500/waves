...
```
emcc -std=c++17 -I../Empirical/source/ -Os --js-library ../Empirical/source/web/library_emp.js -s EXPORTED_FUNCTIONS="['_main', '_empCppCallback']" -s NO_EXIT_RUNTIME=1 main.cc -o main.js
```
...
:school_satchel: Can you figure out how to add an [`emp::web::TextArea`](https://github.com/devosoft/Empirical/blob/master/source/web/TextArea.h) and use `std::cout` to print whatever the user enters to the console?
