...
![AagosBrain.hpp](https://i.imgur.com/KPOGi8M.png){:style="width: 600px; height: 65px; border: 10px;"}
...
![EvalAagos.hpp](https://i.imgur.com/Kwvmgjt.png){:style="width: 600px; height: 65px; border: 10px;"}
...
![DynamicAagos.mabe](https://i.imgur.com/QaF50ZM.png){:style="width: 600px; height: 65px; border: 10px;"}
